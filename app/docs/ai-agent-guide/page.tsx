...
export default async function AIAgentGuidePage() {
  ...
  const markdownPath = path.join(process.cwd(), 'docs', 'ai-agent-guide.md')
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-lg max-w-none prose-headings:text-base-content prose-p:text-base-content prose-strong:text-base-content prose-code:text-base-content prose-blockquote:text-base-content prose-li:text-base-content">
            <ReactMarkdown 
              ...
              components={{
                ...
                h4: ({ children }) => (
                  <h4 className="text-xl font-semibold mb-3 mt-5 text-base-content">
                    {children}
                  </h4>
                ),
                blockquote: ({ children }) => (
                ...
                p: ({ children }) => {
                  ...
                  if (text.includes('✅') || text.includes('❌')) {
                    return (
                      <p className="text-base text-base-content/80 my-2">
                        {children}
                      </p>
                    )
                  }
          ...
          <div className="mt-12 pt-8 border-t border-base-300">
            <div className="flex justify-between items-center">
              ...
              <Link href="/docs/supabase-setup" className="btn btn-ghost">
...
export const metadata = {
  ...
  description: 'Complete guide for using the Vibe Template with AI agents for rapid development',
} 